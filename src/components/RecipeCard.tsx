    ...
    <Link href={`/recipes/${recipe._id}`}>
      <div className={`relative bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 ${isDeleting ? 'scale-95 opacity-0' : ''}`}>
        ...
        <button
          ...
          className="absolute top-2 right-2 z-10 p-2 rounded-full bg-white/80 hover:bg-red-50 text-red-500 hover:text-red-600 transition-colors duration-200"
        >
        ...
        {showConfirm && (
          <div className="absolute inset-0 z-20 bg-white/95 flex flex-col items-center justify-center gap-4 p-4 transition-opacity duration-300 ease-in-out">
